        ...
        setOrderList([
            ...
            <Orders
                ...
                data-number-of-offers-items={
                    object["data-number-of-offers-items"]
                }
            ...
            <Box className="game-layout">
                <Box className="content-manager-page">
                    ...
                    >
                        <Box
                            id="cards-div-offer"
                            className="cards-div cards-div-offer"
                        >
                            <Box
                                id="offer-cards-inner-div"
                                className="offer-cards-inner-div"
                            >
                                <Box
