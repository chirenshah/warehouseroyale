...
function GameLayout() {
    ...
    function getSelectedOffer (obj) {
        ...
        document.getElementById('selected-offer-purchase-btn').classList.remove('selected-offer-purchase-btn-disabled');
        document.getElementById('selected-offer-purchase-btn').classList.add('selected-offer-purchase-btn-activated');
    }
