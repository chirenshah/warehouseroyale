...
function Offer(props) {
    ...
    function clickHandler(e) {
        ...
        if (!props["disableDataFetch"]) {
            ...
            for (let itr = 0; itr < document.getElementsByClassName("offer-cards").length; itr++) {
                document.getElementsByClassName("offer-cards")[itr].classList.add("unselected-offer-card");
                document.getElementsByClassName("offer-cards")[itr].classList.remove("selected-offer-card");
            }
